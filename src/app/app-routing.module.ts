...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'permissions',canActivate: [AuthGuard],
        loadChildren: () =>
      ...
      },
      {
       ...
       {
        path: 'agreements',canActivate: [AuthGuard],
        loadChildren: () =>
      ...
      {
        path: 'renewal',canActivate: [AuthGuard],
        loadChildren: () =>
          import('./renewal/renewal.module').then((m) => m.RenewalModule)
      },
       {
      ...
      {
        path: 'revenue',canActivate: [AuthGuard],
        loadChildren: () =>
          import('./revenue/revenue.module').then((m) => m.RevenueModule)
      },
      {
        path: 'others',canActivate: [AuthGuard],
        loadChildren: () =>
          import('./other-menu/other-menu.module').then((m) => m.OtherMenuModule)
      },
      {
        path: 'approvals',canActivate: [AuthGuard],
        loadChildren: () =>
          import('./approval-management/approval-management.module').then((m) => m.ApprovalManagmentModule)
      },
      {
